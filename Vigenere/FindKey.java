...
public class FindKey {
    ...
    public static int keyLength = 14;
    ...
    public static void initialize(char[] ciphertext) {
        ...
        char[] chromosome = new char[keyLength];
    ...
    public static void mate(char[] ciphertext) {
        ...
        for(int i = 0; i < 5; i++) {
            parent1 = random.nextInt(10);
            parent2 = random.nextInt(10);
            while(parent1 == parent2) {
                parent2 = random.nextInt(10);
            }
            crossover(population.get(parent1).getChromosome(), population.get(parent2).getChromosome(), ciphertext);
        }
    ...
    public static void crossover(String parent1, String parent2, char[] ciphertext) {
        ...
        int i = 0;
        int point = random.nextInt(keyLength - 1 - 1) + 1;
        char[] child = new char[keyLength];
        
        for(i = 0; i < point; i++) {
            child[i] = parent1.charAt(i);
        }
        
        for(i = point; i < keyLength; i++) {
    ...
    public static void mutate(String child, char[] ciphertext) {
        ...
        int point = random.nextInt(keyLength);
